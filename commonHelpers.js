...
</div>`}function m(e){return e.map(f).join("")}const h="/goit-js-hw-12/assets/icon-error-9956cb73.svg",s={form:document.querySelector(".js-form"),containerImg:document.querySelector(".js-container-images"),body:document.body,cssLoader:document.querySelector(".js-loader")},d=new c(".js-container-images a",{captionsData:"alt",captionPosition:"bottom",captionClass:"caption-text"});s.form.addEventListener("submit",g);function g(e){e.preventDefault(),s.body.style.height="100vh",s.containerImg.innerHTML="";let o=e.target.elements.query.value.trim();if(o===""){l("Fill in the field!");return}o=o.replaceAll(" ","+"),y(),p(o).then(i=>{if(i.hits.length===0)l("Sorry, there are no images matching your<br> search query. Please, try again!");else{const a=m(i.hits);s.containerImg.innerHTML=a,i.hits.length<4?s.body.style.height="100vh":s.body.style.height="100%",d.refresh()}}).catch(i=>{l("An error occurred. Please try again later.",i)}).finally(()=>{L()}),e.target.reset()}function y(){s.cssLoader.style.display="block"}function L(){s.cssLoader.style.display="none"}function l(e,o=null){const i={message:e,backgroundColor:"#EF4040",iconUrl:h,timeout:5e3,closeOnEscape:!0,transitionIn:"fadeInLeft",transitionOut:"fadeOutUp",titleSize:"16",titleLineHeight:"24",messageSize:"16",messageLineHeight:"24",titleColor:"#FFF",messageColor:"#FFF",position:"topRight"};o!==null&&(i.title=`${o}`),u.show(i)}
